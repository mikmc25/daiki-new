...
let fetchTorrent = async (query, type = "series") => {
  ...
  //     : ""
  // }&Category%5B%5D=8000&Category%5B%5D=127246&Tracker%5B%5D=torrentproject2&cache=false`;

  let url = `${
    hostdata.host
  }/api/v2.0/indexers/torlock/results/torznab/api?apikey=${
    hostdata.apiKey
  }&${
...
app
  .get("/manifest.json", (req, res) => {
    ...
    var json = {
      ...
      version: "1.0.2",
      name: "Torrentproject2 Addon",
      description: "Movie & TV Streams from Jackett ",
      logo: "https://www.userlogos.org/files/torrentproject2.png",
      resources: [
        {
          name: "stream",
          types: ["movie", "series"],
